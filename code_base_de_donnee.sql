...
-- Version 2.0 — Mise à jour complète pour le projet Web Dynamique
-- ============================================================================
...
CREATE TABLE transports (
    ...
    company VARCHAR(100),
    departure_city VARCHAR(100) DEFAULT 'Paris',
...
-- Kyoto
INSERT INTO transports (destination_id, type, company, departure_time, arrival_time, duration, stops, seats_left, seats_total, price, class) VALUES
(1, 'Vol direct', 'Air France', '11:30', '05:15+1', '13h 45min', 0, 5, 50, 789, 'Économique'),
(1, 'Vol 1 escale', 'Qatar Airways', '15:20', '17:50+1', '20h 30min', 1, 12, 50, 672, 'Économique'),
(1, 'Vol 1 escale', 'Emirates', '21:40', '23:50+1', '20h 10min', 1, 8, 30, 699, 'Affaires');
-- Santorin
INSERT INTO transports (destination_id, type, company, departure_time, arrival_time, duration, stops, seats_left, seats_total, price, class) VALUES
(2, 'Vol direct', 'Transavia', '06:45', '10:30', '3h 45min', 0, 22, 80, 159, 'Économique'),
(2, 'Vol direct', 'Aegean Airlines', '14:10', '18:05', '3h 55min', 0, 9, 80, 210, 'Économique'),
(2, 'Vol 1 escale', 'Lufthansa', '08:00', '14:30', '6h 30min', 1, 15, 60, 185, 'Économique');
-- Bali
INSERT INTO transports (destination_id, type, company, departure_time, arrival_time, duration, stops, seats_left, seats_total, price, class) VALUES
(3, 'Vol 1 escale', 'Singapore Airlines', '19:10', '08:00+1', '18h 50min', 1, 6, 40, 728, 'Économique'),
(3, 'Vol 1 escale', 'Cathay Pacific', '22:00', '14:20+1', '22h 20min', 1, 18, 60, 580, 'Économique');
-- Marrakech
INSERT INTO transports (destination_id, type, company, departure_time, arrival_time, duration, stops, seats_left, seats_total, price, class) VALUES
(4, 'Vol direct', 'Ryanair', '07:00', '09:30', '2h 30min', 0, 30, 120, 89, 'Économique'),
(4, 'Vol direct', 'Royal Air Maroc', '13:00', '15:25', '2h 25min', 0, 14, 100, 145, 'Économique'),
(4, 'Train + Ferry', 'SNCF / Baleària', '06:00', '22:00', '16h', 2, 40, 100, 120, 'Standard');
-- Islande
INSERT INTO transports (destination_id, type, company, departure_time, arrival_time, duration, stops, seats_left, seats_total, price, class) VALUES
(5, 'Vol direct', 'Icelandair', '10:30', '12:15', '3h 45min', 0, 7, 50, 380, 'Économique'),
(5, 'Vol 1 escale', 'SAS', '08:15', '15:40', '7h 25min', 1, 20, 60, 295, 'Économique');
-- New York
INSERT INTO transports (destination_id, type, company, departure_time, arrival_time, duration, stops, seats_left, seats_total, price, class) VALUES
(6, 'Vol direct', 'Air France', '10:00', '12:30', '8h 30min', 0, 10, 50, 520, 'Économique'),
(6, 'Vol direct', 'Delta', '14:30', '17:00', '8h 30min', 0, 4, 50, 480, 'Économique'),
(6, 'Vol 1 escale', 'British Airways', '07:00', '16:00', '11h', 1, 25, 80, 390, 'Économique');
...
-- 6. Insertion des Notifications initiales
